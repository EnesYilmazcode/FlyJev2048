...
# Copied from Flytris (flytris/brain.py). The connectome lives in the Flytris repo's data folder;
# set FLYTRIS_DATA to point elsewhere (the Modal jobs mount it at /root/data/malecns).
